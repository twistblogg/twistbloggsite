...
<Block src="singlebutton" icon="terminal"  variant="accent" text="Live Demo 2" href="https://homepage-virid-theta.vercel.app/"/>



<Block src="singlebutton" icon="folder-plus"  variant="secondary" text="Live Demo 3" href="https://subscribe-page.vercel.app/"/>


<Div mt="5" mb="5" p="10" pt="3" pb="2" bg="postblock" borderRadius="2xl">
Want to design landing pages like above examples, Read this article : <br/><br/>
<A color="accent" href="https://www.twistblogg.com/blog/design-creative-landing-pages-in-blogger" target="_blank">A powerful Drag and Drop Landing Page Builder for blogger for FREE - No Coding</A>.  
</Div> 

For coders, continue reading ...

You can achieve the same results on your existing blogspot blog whether you're using a custom domain name or a free blogspot sub-domain name. Although you need to to take care of some things on a free sub-domain name so please read carefully all the steps given below.  
